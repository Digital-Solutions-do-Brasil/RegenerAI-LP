...
export default function LiveFinalSection() {
  ...
  return (
    <>
      <section id="live" className="relative w-full py-16 sm:py-20 lg:py-24 flex flex-col items-center justify-center overflow-hidden scroll-mt-24">
        {/* Imagem de Fundo */}
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 max-w-5xl flex flex-col items-center text-center space-y-10">
          {/* Textos Superiores */}
          ...
          <div className="bg-[#D3DDD3] rounded-3xl p-6 sm:p-8 lg:p-10 w-full max-w-3xl shadow-2xl flex flex-col items-center text-center space-y-6 relative">
            ...
            {/* Tag de Data/Hora */}
            <div className="bg-[#8BAF96] text-white font-semibold px-5 py-2 rounded-full text-sm sm:text-base shadow-sm">
              06 de Maio às 9h
            </div>

            {/* Botões */}
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-5 w-full justify-center pt-1">
              <button
                onClick={() => setShowForm(true)}
                className="w-full sm:w-auto bg-[#14472A] hover:bg-[#0F351F] text-white font-semibold text-base sm:text-lg px-7 py-3 rounded-full transition-colors shadow-md cursor-pointer"
              >
                Quero Participar
              </button>
              ...
              <a
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#DCE6DC] hover:bg-white text-[#205135] font-semibold text-base sm:text-lg px-7 py-3 rounded-full transition-colors shadow-md border border-[#8BAF96]/30"
              >
